...
DATA_DIR = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'gentium')
DEFAULT_FONTS = [os.path.join(DATA_DIR, 'GenBkBasB.ttf'), os.path.join(DATA_DIR, 'GenBkBasBI.ttf'), \
    os.path.join(DATA_DIR, 'GenBkBasI.ttf'), os.path.join(DATA_DIR, 'GenBkBasR.ttf')]
